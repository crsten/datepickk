	...
	var languages = {
		...
		en: {
			...
			labels: {
				...
				selectWeekday: (dayWeek) => { return 'Select all ' +  languages['en'].dayNamesFull[dayWeek]; }, 
				selectMonth: (month) => { return 'Select all days of the month of ' + languages['en'].monthNames[month]; },
			},
			weekStart:0
		},
		de: {
		...
		br: {
			...
			labels: {
				...
				selectWeekday: (dayWeek) => { return 'Seleciona todos os(as) ' +  languages['br'].dayNamesFull[dayWeek]; }, 
				selectMonth: (month) => { return 'Seleciona todos os dias do mês de ' + languages['br'].monthNames[month]; },
			},
			weekStart:0
		},
		es: {
			...
			labels: {
				...
				selectWeekday: (dayWeek) => { return 'Seleccionar todos los(as) ' + languages['es'].dayNamesFull[dayWeek]; },
				selectMonth: (month) => { return 'Selecciona todos los días del mes de ' + languages['es'].monthNames[month]; },
			},
			weekStart:0
		}
	};
